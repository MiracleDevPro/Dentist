        ...
        <CardContent>
          <div className="flex justify-center items-center h-full">
            <div className="text-center w-full">
              <h3 className="font-semibold text-gray-800 mb-2 text-2xl manrope-light">Ready to Analyze</h3>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="flex flex-row items-start gap-4">
          <div className="flex flex-col items-start">
            ...
            />
            {sampleSize > 1 && (
              <span className="text-xs mt-1 text-gray-600">Area sample: {sampleSize}×{sampleSize}px</span>
            )}
          </div>
          <div>
            <div className="inline-flex mb-2">
              <Badge variant="outline" className="bg-gray-200 text-gray-800 border border-gray-300 text-sm font-medium px-3 py-1 rounded-md">
                {typeof vitaShade === 'string' ? vitaShade : (vitaShade ? String(vitaShade) : 'Unknown')}
              </Badge>
            </div>
            <p className="text-xs text-gray-600">Best Vita match</p>
            ...
            {calibrationLab && (
              <span className="text-xs text-green-600 font-medium">Calibrated results</span>
            )}
            ...
            <div className="mt-3 pt-2 border-t border-gray-200">
              <div className="text-sm">
                {!pixelData.vitaShade || !pixelData.lab ? (
                  <>
                    <div className="text-sm font-medium text-slate-700">Clinical Insight:</div>
                  ...
                  (() => {
                    try {
                      ...
                      const diffBadgeColor = suggestion.difference.significant ? 
                        (suggestion.difference.deltaE > 5 ? "bg-gray-200 text-gray-800 border-gray-300" : "bg-gray-200 text-gray-800 border-gray-300") :
                      ...
                      return (
                        <>
                          <div className="flex justify-between">
                            <div className="text-sm font-medium text-slate-700">Clinical Insight:</div>
                            <div className={`px-2 py-0.5 text-xs font-medium rounded-md border ${diffBadgeColor}`}>
        ...
        {/* RGB Values */}
        <div>
          <h4 className="text-sm font-medium text-slate-700 mb-3">RGB Values</h4>
          <div className="grid grid-cols-3 gap-3">
            <div className="bg-gray-100 p-3 rounded-lg text-center border border-gray-300">
              <div className="font-medium text-red-600 text-xs">R</div>
              <div className="font-medium text-gray-800 text-sm">{rgb.r}</div>
            </div>
            <div className="bg-gray-100 p-3 rounded-lg text-center border border-gray-300">
              <div className="font-medium text-green-600 text-xs">G</div>
              <div className="font-medium text-gray-800 text-sm">{rgb.g}</div>
            </div>
            <div className="bg-gray-100 p-3 rounded-lg text-center border border-gray-300">
              <div className="font-medium text-gray-600 text-xs">B</div>
              <div className="font-medium text-gray-800 text-sm">{rgb.b}</div>
            </div>
          </div>
        </div>
        ...
        {/* LAB Values */}
        <div>
          <h4 className="text-sm font-medium text-slate-700 mb-3">LAB Values {showHSV && '& HSV'}</h4>
          <div className="bg-gray-100 p-4 rounded-lg border border-gray-300">
            {adjustedLab ? (
                ...
                <div className="mb-3">
                  ...
                  <div className="grid grid-cols-3 gap-4 text-center">
                    <div>
                      ...
                      <div className="font-medium text-gray-800 text-sm">{adjustedLab.L.toFixed(1)}</div>
                      <div className="text-xs opacity-80">Lightness</div>
                    </div>
                    <div>
                      <div className="font-semibold text-sm">a*</div>
                      <div className="text-xl font-bold">{adjustedLab.a.toFixed(1)}</div>
                      <div className="text-xs opacity-80">Green ↔ Red</div>
                    </div>
                    <div>
                      <div className="font-semibold text-sm">b*</div>
                      <div className="text-xl font-bold">{adjustedLab.b.toFixed(1)}</div>
                      <div className="text-xs opacity-80">Blue ↔ Yellow</div>
                    </div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-3 gap-4 text-center">
                <div>
                  <div className="font-semibold text-sm">L*</div>
                  <div className="text-xl font-bold">{lab.L.toFixed(1)}</div>
                  <div className="text-xs opacity-80">Lightness</div>
                </div>
                <div>
                  <div className="font-semibold text-sm">a*</div>
                  <div className="text-xl font-bold">{lab.a.toFixed(1)}</div>
                  <div className="text-xs opacity-80">Green ↔ Red</div>
                </div>
                <div>
                  <div className="font-semibold text-sm">b*</div>
                  <div className="text-xl font-bold">{lab.b.toFixed(1)}</div>
                  <div className="text-xs opacity-80">Blue ↔ Yellow</div>
                </div>
              </div>
            )}
        ...
        {showHSV && pixelData.rgb && (
          <div>
            <h4 className="font-semibold mb-3 text-gray-800">HSV Values</h4>
                ...
                return (
                  <div className="grid grid-cols-3 gap-4 text-center">
                    <div>
                      ...
                      <div className="text-xl font-bold">{(hsv.h * 360).toFixed(0)}°</div>
                      <div className="text-xs opacity-80">Hue</div>
                    </div>
                    <div>
                      <div className="font-semibold text-sm">S</div>
                      <div className="text-xl font-bold">{(hsv.s * 100).toFixed(0)}%</div>
                      <div className="text-xs opacity-80">Saturation</div>
                    </div>
                    <div>
                      <div className="font-semibold text-sm">V</div>
                      <div className="text-xl font-bold">{(hsv.v * 100).toFixed(0)}%</div>
        ...
        {/* Match Quality */}
        <div>
          <h4 className="mb-3 text-2xl text-gray-800 manrope-light">Match Quality</h4>
          <div className="bg-gradient-to-r from-gray-50 to-gray-100 p-4 rounded-xl border border-[#e6e7ea] shadow-sm">
            ...
            {pixelData.confidenceScore !== undefined && (
              <div className="mb-3">
                <div className="flex justify-between items-center mb-1">
                  ...
                  <div className="px-2 py-0.5 text-sm font-bold rounded-md bg-slate-100 text-slate-800 border border-slate-200">
            ...
            <div className="flex justify-between items-center mb-2">
              ...
              <div className={`px-2 py-0.5 text-sm font-bold rounded-md ${deltaE < 2 ? "bg-green-100 text-green-800 border border-green-200" : deltaE < 5 ? "bg-gray-200 text-gray-700 border border-gray-300" : "bg-red-100 text-red-800 border border-red-200"}`}>
                {deltaE.toFixed(1)}
              </div>
            </div>
            ...
            {showHSV && pixelData.deltaHSV !== undefined && (
              <div className="mt-2 pt-2 border-t border-gray-300">
                <div className="flex justify-between items-center mb-1">
                  ...
                  <div className="px-2 py-0.5 text-sm font-bold rounded-md bg-purple-100 text-purple-800 border border-purple-200">
        ...
        {/* Analysis Info */}
        <div className="text-xs text-gray-500 bg-gray-100 p-2 rounded-lg border border-gray-200 flex justify-between">
          <div>
